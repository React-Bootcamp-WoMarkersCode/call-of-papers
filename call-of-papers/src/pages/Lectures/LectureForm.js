...
import { Form, Input, Row, Col, Button, Select, Radio, Checkbox, Upload} from 'antd'
            ...
            >
              ...
              >
                <Input
                  maxLength={9}
                  name="rg"
                  onChange={formik.handleChange} value={formik.values.rg}
                />
              </Form.Item>
              ...
              >
                <Input
                  maxLength={11}
                  name="cellphone"
                  onChange={formik.handleChange} value={formik.values.cellphone}
                />
              </Form.Item>
              ...
              >
                <Input
                  maxLength={11}
                  name="cep"
                  onChange={formik.handleChange} value={formik.values.cep}
                />
              </Form.Item>
              ...
              >
                <TextArea
                  rows={4}
                  name="miniBio"
                  onChange={formik.handleChange} value={formik.values.apresentation}
                />
              </Form.Item>
              ...
              >
                <Input
                  name="linkedin"
                  onChange={formik.handleChange} value={formik.values.linkedinLink}
                />
              </Form.Item>
              ...
              >
                <Input
                  name="facebook"
                  onChange={formik.handleChange} value={formik.values.facebookLink}
                />
              </Form.Item>
              ...
              >
                <Input
                  name="twitter"
                  onChange={formik.handleChange} value={formik.values.twitterLink}
                />
              </Form.Item>
              ...
              >
                <Input
                name="github"
                onChange={formik.handleChange} value={formik.values.githubLink}
                />
              </Form.Item>
              ...
              >
                <Input
                  name="activityTitle"
                  onChange={formik.handleChange} value={formik.values.activityTitle}
                />
              </Form.Item>
              ...
              >
                <TextArea
                  ...
                  onChange={formik.handleChange} value={formik.values.activityDescription}
                />
              </Form.Item>
