      ...
      <>
        ...
        <Row gutter={[16, 24]} className='home-cards-container'>
          <Col span={16} offset={4} style={{ textAlign: 'justify' }}>
            ...
            <p>A plataforma <i>Sharing Talks</i> é o projeto final desenvolvido no <a href='https://womakerscode.org/' target="_blank" rel="noopener noreferrer"><strong>React Bootcamp da WoMakersCode</strong></a> como forma de aplicar os conhecimentos adquiridos ao longo do curso.
